...
class AES_SHA256 implements iCryptoSystem
{
    const IV_SIZE = 16;
    ...
    public function encrypt($data, $expiration)
    {
        ...
        $encData = openssl_encrypt($data, 'AES-256-CBC', $this->symmetricKey, null, $iv);
    ...
    public function decrypt($data)
    {
        ...
        $data = trim(openssl_decrypt($encData, 'AES-256-CBC', $this->symmetricKey, null,$iv));
    ...
    function getTID()
    {
        return substr(md5(md5($this->symmetricKey) . 'AES_SHA256' . md5($this->HMACKey)), 0, 8);
    }
}
